...
public final class ConstantsPresentation {
   ...
   * @since 1.0.0
   */
  public static final String RESPONSE_DESCRIPTION_STATUS_CODE_422 =
      "Valid payload, but with invalid content.";
   ...
   * @since 1.0.0
   */
  public static final String OPENAPI_DOCUMENTATION_PURCHASE_ID =
      "Mandatory field responsible for holding purchase identification information.";
   ...
   * @since 1.0.0
   */
  public static final String OPENAPI_DOCUMENTATION_PURCHASE_TRANSACTION_DATE =
      "Mandatory field responsible for holding the purchase transaction date. Must be in the past.";
   ...
   * @since 1.0.0
   */
  public static final String OPENAPI_DOCUMENTATION_PURCHASE_DESCRIPTION =
      "Mandatory field responsible for holding the purchase description containing at most fifty characters. Must not be null, empty or filled with spaces only.";
   ...
   * @since 1.0.0
   */
  public static final String OPENAPI_DOCUMENTATION_PURCHASE_AMOUNT =
      "Mandatory field responsible for holding the purchase transaction amount. Must be a positive decimal number.";
