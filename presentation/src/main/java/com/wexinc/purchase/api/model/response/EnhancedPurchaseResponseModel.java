 ...
 * @version 1.0.0
 */
public record EnhancedPurchaseResponseModel(Long id, String description, LocalDateTime transactionDate,
		BigDecimal amount, Collection<ExchangeRateDataResponseModel> exchangeRateData) {
}
