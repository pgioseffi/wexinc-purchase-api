...
class PurchaseTest {
	...
	void testEqualsAndHashCode() {
		...
		Assertions.assertEquals(purchase01.hashCode(), purchase02.hashCode(), Constantes.EXPECTED_THE_SAME_RESULT);

		Assertions.assertNotEquals(purchase01, purchase03, Constantes.EXPECTED_DIFFERENT_RESULT);
		Assertions.assertNotEquals(purchase01.hashCode(), purchase03.hashCode(), Constantes.EXPECTED_DIFFERENT_RESULT);
	...
	void testModifiersMethods() {
		...
		Assertions.assertEquals(purchase01, purchase02, Constantes.EXPECTED_THE_SAME_RESULT);
		Assertions.assertEquals(purchase01.getId(), purchase02.getId(), Constantes.EXPECTED_THE_SAME_RESULT);
		Assertions.assertEquals(purchase01.getDescription(), purchase02.getDescription(),
				Constantes.EXPECTED_THE_SAME_RESULT);
		Assertions.assertEquals(purchase01.getTransactionDate(), purchase02.getTransactionDate(),
				Constantes.EXPECTED_THE_SAME_RESULT);
		Assertions.assertEquals(purchase01.getAmount(), purchase02.getAmount(), Constantes.EXPECTED_THE_SAME_RESULT);
	}
}
