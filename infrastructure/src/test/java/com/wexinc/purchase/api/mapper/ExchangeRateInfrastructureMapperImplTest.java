...
class ExchangeRateInfrastructureMapperImplTest {
  ...
  private final ExchangeRateInfrastructureMapper MAPPER =
      Mappers.getMapper(ExchangeRateInfrastructureMapper.class);

  @Test
  void shouldNotMap() {
    Assertions.assertNull(
        this.MAPPER.fromResourceToDTO(null), Constantes.SHOULD_HAVE_RETURNED_NULL);
  }

  @Test
  void shouldNotMapData() {
    Assertions.assertEquals(
        new ExchangeRateDTO(null),
        this.MAPPER.fromResourceToDTO(new ExchangeRateResource(null)),
  ...
  void shouldNotMapDataItem() {
    Assertions.assertEquals(
        new ExchangeRateDTO(Arrays.asList((ExchangeRateDataDTO) null)),
        this.MAPPER.fromResourceToDTO(
            new ExchangeRateResource(Arrays.asList((ExchangeRateDataResource) null))),
        Constantes.EXPECTED_THE_SAME_RESULT);
  }
