...
public interface PurchaseInfrastructureMapper {
   ...
   * @return The {@link PurchaseDTO} object containing purchase information converted into the data
   *     transfer object among the different layers of the application.
   * @since 1.0.0
   */
   ...
   *
   * @param purchaseDTO The data transfer object {@link PurchaseDTO} containing purchase information
   *     that will be converted into the {@link Purchase} object used by the repository layer.
   * @return The {@link Purchase} object containing purchase information that will be used only by
