...
/**
 * Interface responsible for holding the signatures of methods written by developers for access and
 * persistence to/in the database, as well as pre-defined Spring methods.
 *
