...
/**
 * Class responsible for consume the treasury reporting rates exchange API in order to calculate
 * exchange rate and return a purchase amount already converted.
 *
 * @author <a href="mailto:pgioseffi@gmail.com">Philippe Gioseffi &lt;pgioseffi@gmail.com&gt;</a>
 * @since 1.0.0
 * @version 1.0.0
 */
public class AmericanTreasuryRateExchangeAPIWebClient
    implements AmericanTreasuryRateExchangeAPIClient {

  /**
   * Field that will be used to consume the treasury reporting rates exchange API in order to
   * calculate exchange rate and return a purchase amount already converted.
   *
   * @since 1.0.0
   */
  ...
  /**
   * Field that holds dynamic application properties such as the treasury reporting rates exchange
   * API URL.
   *
   * @since 1.0.0
   */
   ...
   *     field of this
   * @param exchangeRateInfrastructureMapperParam Parameter responsible to initialize the {@link
   *     #exchangeRateInfrastructureMapper} field of this class.
   * @since 1.0.0
   */
  public AmericanTreasuryRateExchangeAPIWebClient(
      final RestClient restClientParam,
   ...
   *
   * @since 1.0.0
   * @throws HttpClientErrorException.NotFound If does not find any exchange rate according to the
   *     given countries.
   */
  @Override
            ...
            .uri(
                this.consulProperties
                    ...
                    .formatted(
                        ...
                        date.toLocalDate(),
                        countries.stream()
                            .map(Country::getCapitalizedName)
                            .collect(Collectors.joining(","))))
            .accept(MediaType.APPLICATION_JSON)
            .retrieve()
            .body(ExchangeRateResource.class);
