...
/**
 * Class responsible for maintaining the abstraction of information with the purchase table in the database.
 *
...
public class Purchase {
	...
	/**
	 * Field responsible for holding the purchase description. Must not be null or empty and can have only fifty
	 * characters.
	 *
	 * @since 1.0.0
	 */
	 ...
	 * @param descriptionParam     Parameter responsible to set the value of the {@link #description} field.
	 * @param transactionDateParam Parameter responsible to set the value of the {@link #transactionDate} field.
	...
	/**
	 * Method responsible for returning the {@link LocalDateTime} value of the {@link #transactionDate} field.
	 *
	...
	public String toString() {
		return "Purchase [id=%d, description=%s, transactionDate=%s, amount=%.2f]".formatted(Long.valueOf(this.id),
				this.description, this.transactionDate, this.amount);
	}
}
