...
public enum Country {
	...
	/**
	 * Method responsible to return the {@link #name()} of the enum with only its first letters of each word
	 * capitalized.
	 *
	...
	public String getCapitalizedName() {
		return String.join(" ",
				Stream.of(ConstantsCore.PATTERN_UNDERSCORE.split(this.name().toLowerCase(Locale.getDefault())))
