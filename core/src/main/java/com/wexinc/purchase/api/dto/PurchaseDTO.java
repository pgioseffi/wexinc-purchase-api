...
/**
 * Object responsible for transporting complete information about a purchase through the different layers of the
 * application.
 *
 ...
 * @version 1.0.0
 */
public record PurchaseDTO(Long id, String description, LocalDateTime transactionDate, BigDecimal amount) {
}
