...
/**
 * Concrete class containing the business rules to search for a purchase and enhance its information with its exchange
 * rate according to the countries given.
 *
...
public class FindEnchancedPurchaseByIdInteractor implements FindEnhancedPurchaseByIdInputBoundary {
	...
	/**
	 * Field responsible to hold the implementation of the interactor that finds a purchase by its numeric positive
	 * identifier.
	 *
	 * @since 1.0.0
	 */
	 ...
	 *
	 * @param findPurchaseByIdInputBoundaryParam         Parameter responsible for holding the gateway that will
	 *                                                   initialize the {@link #findPurchaseByIdInputBoundary} field of
	 *                                                   this class.
	 * @param americanTreasuryRateExchangeAPIClientParam Parameter responsible for holding the gateway that will
	 *                                                   initialize the {@link #americanTreasuryRateExchangeAPIClient}
	 *                                                   field of this class.
	 * @since 1.0.0
	 */
	public FindEnchancedPurchaseByIdInteractor(final FindPurchaseByIdInputBoundary findPurchaseByIdInputBoundaryParam,
	...
	public EnhancedPurchaseDTO apply(final Long id, final Collection<Country> countries) {
		...
		return new EnhancedPurchaseDTO(purchaseDTO.id(), purchaseDTO.description(), purchaseDTO.transactionDate(),
				purchaseDTO.amount(), modifiableAndOrderedList);
	}
}
