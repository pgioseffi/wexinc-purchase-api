...
/**
 * Interface responsible for holding the signature of the method that will consume the treasury
 * reporting rates exchange API in order to calculate exchange rate and return a purchase amount
 * already converted.
 *
